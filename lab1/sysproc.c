...
--*/
{
	...
	fprintf(StdHandle, "pm:show physical memory information.\n");
	fprintf(StdHandle, "vm:show virtual address descriptor of the spicified process.\n");
}
